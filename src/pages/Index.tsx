      ...
      <section className="relative pt-16 overflow-hidden">
        ...
        <div className="relative container flex flex-col items-center text-center py-24 md:py-36 gap-8">
          ...
          <motion.h1
            ...
            className="font-display font-bold text-4xl md:text-6xl lg:text-7xl max-w-4xl leading-tight"
          >
      ...
      <section className="container py-20 md:py-28">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg max-w-lg mx-auto">
            From scanning a QR code to downloading your photos in seconds
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <StepCard
            ...
            description="Scan the QR code at the venue or enter the event code to join instantly."
            icon={QrCode}
            delay={0}
          />
          <StepCard
            ...
            description="Take a quick selfie. Our AI will use it to find you in all event photos."
            icon={Camera}
            delay={0.15}
          />
          <StepCard
            ...
            description="Browse, download, and share every photo you appear in. It's magical."
            icon={Images}
            delay={0.3}
          />
        </div>
